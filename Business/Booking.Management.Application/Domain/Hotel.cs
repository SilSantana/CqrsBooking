...
namespace Booking.Management.Application.Domain
{
    internal class Hotel : Aggregate
    {
        ...
        public Hotel(string name, int starsOfCategory, Address address, Contacts contacts, Guid code = default(Guid), Guid? identifier = null) : base(identifier)
        {
            Name = name;
            ...
            {
                Code = Guid.NewGuid();
                AddEvent(new HotelCreated(Code, Name, StarsOfCategory, StarsOfRating, Address, Contacts));
            };
        }
