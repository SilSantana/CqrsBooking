...
namespace Booking.Management.Application.Domain
{
    internal class Address : ValueObject
    {
        ...
        public static Outcome<Address> Create(PossibleBe<string> street, PossibleBe<string> district, PossibleBe<string> city, PossibleBe<string> country, PossibleBe<int> zipCode)
        {
