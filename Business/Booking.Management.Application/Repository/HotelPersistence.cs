...
namespace Booking.Management.Application.Repository
{
    internal class HotelPersistence
    {
        ...
        public HotelPersistence(IEventPublisher eventPublisher, IRavenDocumentStoreHolder ravenDocumentStore)
        {
