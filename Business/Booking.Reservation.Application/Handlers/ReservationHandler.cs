...
namespace Booking.Reservation.Application.Handlers
{
    internal class ReservationHandler : ICommandHandler<MakeRoomReservation>, ICommandHandler<CancelReservation>
    {
